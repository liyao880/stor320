...
During the presentation, I will evaluate the clarity of the question, the explanation of the methods, and the organization of the content. Additionally, I will assess the presentation skills and the quality of the slides. Slides should not be cluttered, too wordy, unreadable, or plain. The Orator should not read directly from the slides. This is a short presentation that should be well-rehearsed.
...
The final presentations will take place during the last three lectures. Time slots will be prioritized according to email and posted on a google spreadsheet linked on the website. I highly recommend scheduling your meeting as soon as possible to ensure you have a preferred spot. The Deliverer is responsible for submitting the slides to Sakai. The slides are due **before presentation day**. For example, if the group is scheduled to present on Nov 26, the slides should be submitted by Nov 25 (11:55PM). If your Deliverer fails to submit the slides before the deadline, a minimum 2 point penalty will be given. This penalty applies to your entire group. Attendance of all members is required. Each member that fails to attend will automatically lose five points from their individual grade. 
