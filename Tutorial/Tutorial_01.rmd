...
For **our** class we will **Knit to HTML**.

For more assistance with RMarkdown, see Chapter 21 in *R for Data Science* and the RMarkdown cheat sheet at <https://evoldyn.gitlab.io/evomics-2018/ref-sheets/rmarkdown-cheatsheet-2.0.pdf>, which link is also found on the [course website](https://liyao880.github.io/stor320/).
